...
//  const std::string sInputDir = "/home/boris/area51/openmvg/src/openMVG_Samples" \
//    "/imageData/SceauxCastle/";
  const std::string sInputDir =  "/home/boris/Desktop/RectifiedImgs/pad/stair0/";
  Image<RGBColor> image;

//  const string jpg_filenameL = sInputDir + "100_7101.jpg";
//  const string jpg_filenameR = sInputDir + "100_7102.jpg";

  const string jpg_filenameL = sInputDir + "img00.jpg";
  const string jpg_filenameR = sInputDir + "img01.jpg";


  Image<unsigned char> imageL, imageR;
  auto r = ReadImage(jpg_filenameL.c_str(), &imageL);
  cout << jpg_filenameL << " r " << r << endl;
